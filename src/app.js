...
app.use("/vendor-categories", require("./routes/vendorCategory.routes"));
app.use("/vendor-analytics", require("./routes/vendorAnalytics.routes"));
app.use("/vendor-sync", require("./routes/vendorSync.routes"));
